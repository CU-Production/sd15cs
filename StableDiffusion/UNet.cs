...
public static class UNet
{
    ...
    public static SixLabors.ImageSharp.Image<SixLabors.ImageSharp.PixelFormats.Rgba32> Inference(String prompt, StableDiffusionConfig config)
    {
        // Preprocess text
        ...
        for (int t = 0; t < timesteps.Length; t++)
        {
            ...
            var splitTensors = TensorHelper.SplitTensor(outputTensor, new int[] { 1, 4, config.Height / 8, config.Width / 8 });
